...
ThemeSupport.ColorUsage={Unknown:0,Foreground:1<<0,Background:1<<1,};export function createDocumentationLink(article,title){return UI.XLink.create('https://developers.9oo91e.qjz9zk/web/tools/chrome-devtools/'+article,title);}
